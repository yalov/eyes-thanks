...
{
    // mutual
    setWindowTitle(qApp->translate("App", "Eyes' Thanks") + " v"+ QString(APP_VERSION));
    ...
    // tab1
    Label_UntilBreak->setText(qApp->translate("App", "Until break") + ":");
    Label_BreakDuration->setText(tr("Break duration") + ":");
    Spinbox_UntilBreak->setSuffix(" " + qApp->translate("App","min") + ".");
    Spinbox_BreakDuration->setSuffix(" " + qApp->translate("App","sec") + ".");
    ...
    Label_Path->setToolTip(tr("Choose folder with images (jpg, png, gif), or leave empty."));
    ...
    GroupBox_PredeterminedBackground->setTitle(tr("Autogenerated Backgrounds"));
